        ...
        <div class="container px-5 py-24 mx-auto">
            <div class="lg:w-2/4 w-full mx-auto overflow-auto">
                <div class="flex items-center justify-between mb-2">
                    <h1 class="text-2xl font-medium title-font mb-2 text-gray-900">Adicionar Editora</h1>
                </div>
                    ...
                    <div class="flex flex-wrap">
                        ...
                        <div class="p-2 w-1/2">
                            <div class="relative">
                                ...
                                <input type="text" id="founded_year" name="founded_year" value="{{ old('founded_year')}}"
                                       class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                            </div>
                            <div class="text-sm text-red-300">
                                @error('founded_year')
                        ...
                        <div class="p-2 w-full flex justify-end">
                            <a href="{{ route('publishers.index') }}" type="submit"
